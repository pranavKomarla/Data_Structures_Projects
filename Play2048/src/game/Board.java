...
public class Board {
    ...
    public void addRandomTile() {
        ...
        BoardSpot boardSpot = openSpaces.get(StdRandom.uniform(0, openSpaces.size())); 
        double randomDouble = StdRandom.uniform(0.0, 1.0);

        if(randomDouble < 0.1)
        {
            gameBoard[boardSpot.getRow()][boardSpot.getCol()] = 4;
        }
        else
            gameBoard[boardSpot.getRow()][boardSpot.getCol()] = 2;
