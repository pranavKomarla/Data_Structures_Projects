...
public class MindStoneNeighborNeurons {
    ...
    public static void main (String [] args) {
        ...
        ArrayList<String>[] array = new ArrayList[numberVertices];
        ...
        System.out.println(numberEdges);
        ...
        for(int i = 0; i < numberEdges; i ++)
        {
            ...
            {
                if(array[j].contains(firstString))
                    array[j].add(secondString);
